    ...
    <div class="container">
        <?php if (isset($_GET['created'])): ?>
            <div class="alert alert-success fade-in" style="margin-top: 2rem;">
                ✅ Quiz créé avec succès ! Vous pouvez maintenant le partager avec vos étudiants.
            </div>
        <?php endif; ?>
            ...
            <div class="card fade-in" style="margin-bottom: 2rem;">
                <div style="display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
                    <div class="form-group" style="flex: 1; margin: 0;">
                        <input type="text" id="search-quiz" class="form-control" placeholder="🔍 Rechercher un quiz..." onkeyup="filterQuizzes()">
                    </div>
