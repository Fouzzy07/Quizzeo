...
<head>
    ...
    <title>Modifier Quiz - <?php echo SITE_NAME; ?></title>
    ...
    <nav class="navbar">
        <div class="navbar-content">
            ...
            <div class="navbar-menu">
                <a href="dashboard.php" class="navbar-link">Mes Quiz</a>
            ...
            <form method="POST" action="">
                ...
                <?php foreach ($questions_with_answers as $index => $q_data): ?>
                    <div class="question-block">
                        <h4>Question <?php echo $index + 1; ?> - <?php echo $q_data['question']['points']; ?> points</h4>
                            ...
                            <?php foreach ($q_data['answers'] as $answer): ?>
                                <li style="margin: 0.5rem 0;">
                                    ...
                                    <?php if ($answer['is_correct']): ?>
                                        <span class="badge badge-active">Correcte</span>
                                    <?php endif; ?>
                                </li>
                            <?php endforeach; ?>
                        </ul>
