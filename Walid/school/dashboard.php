...
<head>
    ...
    <title>Dashboard École - <?php echo SITE_NAME; ?></title>
    ...
    <div class="container">
        ...
        <?php if (empty($user_quizzes)): ?>
            <div class="empty-state fade-in">
                ...
                <p>Commencez par créer votre premier quiz pour vos étudiants.</p>
                <a href="create_quiz.php" class="btn btn-primary">Créer mon premier quiz</a>
            </div>
        <?php else: ?>
            <div class="quiz-list">
